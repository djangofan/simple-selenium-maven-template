...
import static qa.test.selenium.config.DriverBinaryMapper.configureBinary;
import static qa.test.selenium.config.DriverBinaryMapper.getBinaryPath;
import static qa.test.selenium.config.SystemArchitecture.getSystemArchitecture;
