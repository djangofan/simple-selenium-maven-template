package qa.test.selenium;

import qa.test.selenium.config.DriverType;
import qa.test.selenium.listeners.ScreenshotListener;
...
import static qa.test.selenium.config.DriverType.determineEffectiveDriverType;
